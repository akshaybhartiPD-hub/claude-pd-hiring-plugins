...
1. Create a repo, e.g. `paralleldots/claude-hiring-plugins`.
...
3. Commit and push:
   ...
   git branch -M main
   git remote add origin https://github.com/paralleldots/claude-hiring-plugins.git
...
```
/plugin marketplace add paralleldots/claude-hiring-plugins
